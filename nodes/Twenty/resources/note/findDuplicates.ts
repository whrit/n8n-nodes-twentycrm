...
export const noteFindDuplicatesDescription: INodeProperties[] = [
	{
		displayName: 'Depth',
		name: 'depth',
		type: 'options',
	...
	},
	{
		...
		description: 'List of note IDs to check for duplicates',
		displayOptions: {
			show: displayOptions,
		},
	},
	{
		...
		default: '[]',
		description:
			'Optional raw JSON array of note payloads to compare against existing records',
		displayOptions: {
			show: displayOptions,
		},
	},
