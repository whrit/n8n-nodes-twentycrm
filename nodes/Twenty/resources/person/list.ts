...
export const personListDescription: INodeProperties[] = [
	{
		...
		description: 'Maximum number of people to return (0-200, default 60)',
		displayOptions: {
			show: displayOptions,
		},
	},
	{
		...
		default: '',
		description:
			'Comma-separated list describing the sort order, e.g. id[AscNullsFirst],createdAt[DescNullsLast]',
		displayOptions: {
			show: displayOptions,
		},
	},
	{
		...
		default: '',
		description:
			'Filter string using Twenty syntax, e.g. createdAt[gte]:"2024-01-01" or emails.primaryEmail[eq]:"user@example.com"',
		displayOptions: {
			show: displayOptions,
		},
	},
